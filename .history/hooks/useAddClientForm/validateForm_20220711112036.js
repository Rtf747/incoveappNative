export const validateForm = (form, target) => {
 ...
 const cedulaValidation = () => {
  if (!form.cedula) {
   errors.cedula = 'El campo "Nombre" no puede estar vacio';
  } else if (!regexName.test(form.cedula.trim())) {
   errors.cedula = "El campo 'Nombre' solo acepta letras y espacios en blanco";
  } else {
   errors.cedula = true;
  }
 };
