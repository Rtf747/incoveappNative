...
export default function AddClient({ navigation }) {
 ...
 const { form, errors, handleChange, handleSubmit } = useAddClientForm();
    ...
    <View style={styles.formContainer}>
     <View style={styles.card}>
      ...
      {form.nameInputChange ? null : (
       <Text>El campo "Nombre" no puede estar vacio</Text>
      )}
      {form.nameIsValid ? null : (
       <Text>El campo "Nombre" no puede contener numeros</Text>
      )}
      <TextInput
       style={styles.input}
       label='Cedula'
      ...
      {form.cedulaInputChange ? null : (
       <Text style>El campo "Cedula" no puede estar vacío</Text>
      )}
      {form.cedulaIsValid ? null : (
      ...
      {form.addressInputChange ? null : (
       <Text style>El campo "Dirección" no puede estar vacío</Text>
      )}
      ...
      {form.phoneInputChange ? null : (
       <Text style>El campo "Teléfono" no puede estar vacío</Text>
      )}
      {form.phoneIsValid ? null : (
       <Text>El campo debe tener al menos 10 digitos</Text>
      )}
      ...
      />
      {form.emailIsValid ? null : (
       <Text>El campo "Email" no puede estar vacío</Text>
      )}
     </View>
    ...
    <Formik
     ...
     {(formikProps) => (
      <View style={styles.formContainer}>
       ...
       <View style={styles.buttonContainer}>
        <Pressable style={styles.button} onPress={formikProps.handleSubmit}>
         <Text style={styles.textButton}>Crear cliente</Text>
        </Pressable>
       </View>
      </View>
