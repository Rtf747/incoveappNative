...
{
 /* <Text style={globalStyles.typography.semiBold[4]}>Ricardo Lahura</Text>
      <Text
       style={[
        globalStyles.typography.regular[5],
        { color: globalStyles.palette.neutral[70] },
       ]}>
       Cedula: 20203576
      </Text>
      <Text
       ...
       Direccion: Jr. Los fresnos 1555. La molina. Lima, Peru. 15095
      </Text>
      <Text
       style={[
        globalStyles.typography.regular[5],
