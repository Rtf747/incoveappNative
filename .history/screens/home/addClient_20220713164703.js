...
import inputs from '../../components/addClient/inputs';
...
export default function AddClient({ navigation }) {
 ...
 const { form, errors, changes, validForm, handleChange, handleSubmit } =
  useAddClientForm();
   ...
   <KeyboardAwareScrollView
    ...
    <View style={styles.formContainer}>
     <View style={styles.card}>
      {inputs.map((input) => (
       <TextinputComponent input={input} form={form} styles={styles} />
      ))}
      {/* <TextInput
       name='name'
       label='Nombre'
       ...
       blurOnSubmit={false}
       error={changes.nameInputChange && errors.nameIsValid ? false : true}
       theme={{
        ...DefaultTheme,
        colors: {
         error: 'red',
      ...
      />
      {changes.nameInputChange ? null : (
       <Text style={styles.errorText}>El campo no puede estar vacio</Text>
      )}
      {errors.nameIsValid || errors.nameIsValid === null ? null : (
